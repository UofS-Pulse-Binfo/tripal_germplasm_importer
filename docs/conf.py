...
htmlhelp_basename = 'GermplasmCrossImporterdoc'
...
latex_documents = [
    (master_doc, 'GermplasmCrossImporter.tex', u'Germplasm Cross Importer Documentation',
     u'Yichao Shen; Lacey Sandersan, University of Saskatchewan, Pulse Bioinformatics', 'manual'),
]
...
man_pages = [
    (master_doc, 'germplasmcrossimporter', u'Germplasm Cross Importer Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'GermplasmCrossImporter', u'Germplasm Cross Importer Documentation',
     author, 'GermplasmCrossImporter', 'One line description of project.',
     'Miscellaneous'),
]
